package gov.epa.ccte.api.ccdapp2.web.rest.errors;
...
/*    @ExceptionHandler({ResourceNotFoundException.class})
    ...
    // this is added to return an empty array instead of 400 error message for no data
    @ExceptionHandler({ResourceNotFoundException.class})
    ResponseEntity<String[]> noDataFoundHandler(){
        String[] returnValue = new String[]{};

        return new ResponseEntity<String[]>(returnValue, HttpStatus.ACCEPTED);
    }
...
/*    @ExceptionHandler({HttpMediaTypeNotSupportedException.class})
    ResponseEntity<VndErrors>  httpMediaTypeNoSupportedHandler (HttpMediaTypeNotSupportedException ex, HttpHeaders headers, HttpStatusCode status, WebRequest request){
